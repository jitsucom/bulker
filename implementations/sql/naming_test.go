	...
	tests := []bulkerTestConfig{
		{
			...
			expectedTable: ExpectedTable{
				Columns: justColumns("id", "name", "column_12b241e808ae6c964a5bb9f1c012e63d", "1test_name", "2", "column_c16da609b86c01f16a2c609eac4ccb0c", "Test Name", "Test Name DROP DATABASE public SELECT 1 from DUAL", "Université Français", "_timestamp", "_unnamed", "lorem_ipsum_dolor_sit_amet_consectetur_adipiscing_elit_sed_do_e", "Странное Имя", "秒速センチメートル"),
			},
		...
		{
			//Redshift is case-insensitive with unquoted identifiers and case-sensitive with quoted identifiers
